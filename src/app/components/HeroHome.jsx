...
Reports available for your city, neighborhood, address, or a<br className='xl:block hidden' /> specific radius
</h6>

            </div>
          </div>

          <div className="absolute xl:block hidden right-0 bottom-0 h-fit w-fit">
            <Image src={homehero} alt="img" />
            <div className="-top-10 left-0 absolute">
              <Image src={herohomechart} alt='chart' />
            </div>
          </div>
        </div>
      </div>
