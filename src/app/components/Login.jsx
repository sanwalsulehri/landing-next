...
const Login = ({signInhandler}) => {
  return (
    ...
    <div className="flex fixed top-0 left-0 min-h-screen w-full h-full z-[999999999999999] items-center px-4 justify-center">
        ...
        <div class="xl:grid xl:grid-cols-12 rounded-2xl overflow-hidden absolute top-1/2 -translate-y-1/2 z-[999] bg-white w-[97%] sm:w-fit xl:w-[95%] mx-auto h-fit xl:h-[95%]">
  <div class="flex flex-1 xl:col-span-5 flex-col justify-center py-12 xl:flex-none px-4 sm:px-20 xl:w-auto xl:px-24">
    <div class="md:mx-auto md:max-w-sm w-full sm:w-96">
      <div>
        <Image class="h-10 w-auto" src={Logo} alt="Your Company" />
  ...
  <div class="relative hidden xl:col-span-7 overflow-hidden flex-1 xl:block">
