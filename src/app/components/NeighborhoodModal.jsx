...
const NeighborhoodModal = ({ closeModal, inputValue, setInputValue,handleCitySearch }) => {
  ...
  return (
    <>
      ...
      <label className="block text-sm font-medium text-gray-700 mb-2">By Neighborhood</label>
      <input
        type="text"
        ref={inputRef}
        placeholder={steps}
      ...
      />
      <ul className='z-50 relative bg-white w-full'>
        {places.map((place) => (
          <li 
            key={place.place_id} 
